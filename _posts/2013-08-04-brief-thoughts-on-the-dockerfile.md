...
Initial experiments are promising.  I [built an image](https://github.com/gorsuch/dockerfile-examples/blob/master/rbenv/Dockerfile) containing a minimal `rbenv` configuration and was able to get an app up and running.  I even opened up my [first amazing pull request](https://github.com/dotcloud/docker/pull/1400) last night.
